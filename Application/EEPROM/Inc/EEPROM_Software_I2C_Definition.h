#ifndef _EEPROM_SOFTWARE_I2C_DEFINITION_H
#define _EEPROM_SOFTWARE_I2C_DEFINITION_H
...
#define EEPROM_I2C_SCL_PIN					((uint16_t)0x0100)                     //GPIO_Pin_8			/* 连接到SCL时钟线的GPIO */
#define EEPROM_I2C_SDA_PIN					((uint16_t)0x0200)                     //GPIO_Pin_9			/* 连接到SDA数据线的GPIO */
